...
const ptBr = {
  ...
  'dashboard.preferences.title': 'Personalizacao',
  'dashboard.preferences.baseCurrency': 'Moeda base',
  'dashboard.preferences.tolerance': 'Tolerancia (%)',
  ...
  'dashboard.preferences.loadError': 'Nao foi possivel carregar as preferencias.',
  'dashboard.preferences.saveError': 'Nao foi possivel salvar as preferencias.',
